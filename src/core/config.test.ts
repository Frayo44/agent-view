...
describe("config", () => {
  ...
  describe("getDefaultConfig", () => {
    test("returns default configuration", () => {
      ...
      expect(config.worktree?.defaultLocation).toBe("subdirectory")
  ...
  describe("worktree config", () => {
    ...
    test("supports different location strategies", () => {
      const locations = ["subdirectory", "sibling", "~/worktrees", "/tmp/worktrees"]
      ...
      for (const location of locations) {
        ...
        expect(config.worktree?.defaultLocation).toBe(location)
      }
    })
